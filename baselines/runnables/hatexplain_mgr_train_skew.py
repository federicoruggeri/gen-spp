...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'hatexplain', f'mgr_skew_{skew_epochs}')
    ...
    config = MGRConfig.from_config(key=ConfigKey(dataset='hatexplain', tags={'spp', 'mgr'}))
    ...
    for seed in config.seeds:
        ...
        if should_train:
            wandb_logger = WandbLogger(project='hlext-hatexplain', name=f'mgr_skew_{skew_epochs}')
        else:
            wandb_logger = None
