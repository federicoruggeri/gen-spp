...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'toy', f'fr_skew_{skew_epochs}')
    ...
    config = FRConfig.from_config(key=ConfigKey(dataset='toy', tags={'spp', 'fr'}))
    ...
    for seed in config.seeds:
        ...
        if should_train:
            wandb_logger = WandbLogger(project='hlext-toy', name=f'fr_skew_{skew_epochs}')
        else:
            wandb_logger = None
