...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'toy', f'mcd_skew_{skew_epochs}')
    ...
    config = MCDConfig.from_config(key=ConfigKey(dataset='toy', tags={'spp', 'mcd'}))
    ...
    for seed in config.seeds:
        ...
        if should_train:
            wandb_logger = WandbLogger(project='hlext-toy', name=f'mcd_skew_{skew_epochs}')
        else:
            wandb_logger = None
